# [SOLVED] Nginx-Stat-Failed-13-Permission-Denied
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/nginx-stat-failed-13-permission-denied)
>
...
Ensure the user running Nginx has read access to the /username/test/static directory.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/nginx-stat-failed-13-permission-denied)**
